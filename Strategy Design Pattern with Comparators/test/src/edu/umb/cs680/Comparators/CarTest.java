package edu.umb.cs680.Comparators;
...
public class CarTest {
    ...
    void verifyCarEqualityWithMakeModelYear() {
        ...
        Assertions.assertArrayEquals(expected, carToStringArray(actual)); // Compare String arrays with the help of
                                                                          // carToStringArray
    }
    ...
    void verifyCar() {
        ...
        Assertions.assertArrayEquals(carToStringArray(expected), carToStringArray(actual)); // Compare String arrays
                                                                                            // with the help of
                                                                                            // carToStringArray
    }
}