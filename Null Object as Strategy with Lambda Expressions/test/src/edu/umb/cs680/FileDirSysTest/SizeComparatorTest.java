...
public class SizeComparatorTest {
    ...
    public void verifyGetChildrenForRepoAsReadmeSrcTest() {
        ...
        Directory dir = repo;
        List<FSElement> element = dir.getChildren((FSElement alphaFS_1, FSElement alphaFS_2) -> Integer
                .compare(alphaFS_2.getSize(), alphaFS_1.getSize()));
    ...
    public void verifyGetSubDirectoriesForRepoAsSrcTest() {
        ...
        Directory dir = repo;
        List<Directory> element = dir.getSubDirectories((FSElement alphaFS_1, FSElement alphaFS_2) -> Integer
                .compare(alphaFS_2.getSize(), alphaFS_1.getSize()));
        Assertions.assertArrayEquals(expected, element.toArray());
    }
    ...
    public void verifyGetFilesForSrcTestAsATestBTest() {
        ...
        List<File> element = dir.getFiles((FSElement alphaFS_1, FSElement alphaFS_2) -> Integer
                .compare(alphaFS_2.getSize(), alphaFS_1.getSize()));
        Assertions.assertArrayEquals(expected, element.toArray());
    }
}